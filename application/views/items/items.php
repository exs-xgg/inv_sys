            ...
            <div class="col-sm-4 hidden" id='createNewItemDiv'>
                <div class="well">
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="unitPrice">(P)Base Price</label>
                                <input type="text" id="itemBasePrice" name="itemBasePrice" placeholder="(P )Base Price" class="form-control"
                                    onchange="checkField(this.value, 'itemBasePriceErr')">
                                <span class="help-block errMsg" id="itemBasePriceErr"></span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="unitPrice">(P)Selling Price</label>
                                <input type="text" id="itemPrice" name="itemPrice" placeholder="(P )Selling Price" class="form-control"
                ...
                <form role="form">
                    ...
                    <div class="row"> 
                        <div class="col-sm-6 form-group-sm">
                            ...
                            <input type="text" id="itemBasePriceEdit" name="itemBasePrice" placeholder="Base Price" class="form-control checkField">
                            <span class="help-block errMsg" id="itemBasePriceEditErr"></span>
                        </div>
                        <div class="col-sm-6 form-group-sm">
                            <label for="unitPrice">Selling Price</label>
                            <input type="text" id="itemPriceEdit" name="itemPrice" placeholder="Selling Price" class="form-control checkField">
