...
<div class='col-sm-6 text-right'><b>Items Total Worth/Price:</b> P <?=$cum_total ? number_format($cum_total, 2) : '0.00'?></div>

<div class='col-xs-12'>
    <div class="panel panel-primary">
        <!-- Default panelP  contents -->
            ...
            <table class="table table-bordered table-striped" style="background-color: #f5f5f5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>P <span id="itemBasePrice-<?=$get->id?>"><?=number_format($get->basePrice, 2)?></span></td>
                        <td>P <span id="itemPrice-<?=$get->id?>"><?=number_format($get->unitPrice, 2)?></span></td>
                        <td><?=$this->genmod->gettablecol('transactions', 'SUM(quantity)', 'itemCode', $get->code)?></td>
                        <td>
                            P <?=number_format($this->genmod->gettablecol('transactions', 'SUM(totalPrice)', 'itemCode', $get->code), 2)?>
                        </td>
