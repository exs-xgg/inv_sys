...
$(document).ready(function(){
    ...
    $("#addNewItem").click(function(e){
        ...
        var itemBasePrice = $("#itemBasePrice").val().replace(",", "");
        var itemCode = $("#itemCode").val();
        var itemDescription = $("#itemDescription").val();
        
        if(!itemName || !itemQuantity || !itemPrice || !itemBasePrice || !itemCode){
            !itemName ? $("#itemNameErr").text("required") : "";
            !itemQuantity ? $("#itemQuantityErr").text("required") : "";
            !itemPrice ? $("#itemPriceErr").text("required") : "";
            !itemBasePrice ? $("#itemBasePriceErr").text("required") : "";
        ...
        $.ajax({
            ...
            data:{itemName:itemName, itemQuantity:itemQuantity, itemPrice:itemPrice, itemBasePrice:itemBasePrice, itemDescription:itemDescription, itemCode:itemCode},
            ...
            success: function(returnedData){
                if(returnedData.status === 1){
                    ...
                    $("#itemBasePriceErr").text(returnedData.itemBasePrice);
            ...
            error: function(){
                if(!navigator.onLine){
                    changeFlashMsgContent("You appear to be offline. Please reconnect to the local network and try again", "", "red", "");
                }
    ...
    $("#itemsListTable").on('click', ".editItem", function(e){
        ...
        var itemBasePrice = $("#itemBasePrice-"+itemId).html().split(".")[0].replace(",", "");
        ...
        $("#itemBasePriceEdit").val(itemBasePrice);
    ...
    $("#editItemSubmit").click(function(){
        ...
        $.ajax({
            ...
            data: {itemName:itemName, itemPrice:itemPrice, itemBasePrice:itemBasePrice, itemDesc:itemDesc, _iId:itemId, itemCode:itemCode}
            ...
            if(returnedData.status === 1){
                ...
                $("#itemBasePriceEditErr").html(returnedData.itemBasePrice);
            }
        }).fail(function(){
            $("#editItemFMsg").css('color', 'red').html("Unable to process your request at this time. Please check your local network connection and try again");
        });
    });
    ...
    $("#stockUpdateSubmit").click(function(){
        ...
        $.ajax({
            ...
            $("#stockUpdateFMsg").html("Unable to process your request at this time. Please check your local network connection and try again");
        });
    });
